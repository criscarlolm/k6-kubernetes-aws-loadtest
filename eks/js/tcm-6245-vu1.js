...
export function EnduranceTest() {
    return {
        stages: [
            { duration: '1m', target: 1, name: 'Stage 1: 1 Users Ramp-up' }, // Ramp-up to 10 virtual users immediately
            { duration: '1m', target: 1, name: 'Stage 2: 1 Users Spike' }, // Spike to 200 virtual users for 1 minute
     ...
     caseNumber
        ...
        variables: {
            data: {
                ...
                shortDesc: `TCM-6245 API Load Testing vu${Math.floor(Math.random() * 10000)}`,
