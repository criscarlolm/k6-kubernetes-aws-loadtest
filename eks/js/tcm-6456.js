...
export default async function () {
    ...
    http.get('https://test.legalmatch.com/case-post/env');
    http.options('https://ccpmtest.legalmatch.com:3010/case-post/rest');
    http.get('https://test.legalmatch.com/case-post/exit/test');
