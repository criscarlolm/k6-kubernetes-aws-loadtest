...
export function EnduranceTest() {
    return {
        stages: [
            { duration: '1m', target: 10, name: 'Stage 1: 10 Users Ramp-up' },
            // Ramp-up to 10 virtual users immediately
            { duration: '1m', target: 200, name: 'Stage 2: 200 Users Spike' },
            // Spike to 200 virtual users for 1 minute
            { duration: '1m', target: 1, name: 'Stage 3: 1 Users Ramp-down' }
     ...
     caseNumber
        ...
        variables: {
            data: {
                ...
                shortDesc: `TCM-6338 API Load Testing vu${Math.floor(Math.random() * 10000)}`,
