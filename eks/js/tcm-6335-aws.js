...
export function Peakload() {
    return {
        stages: [
            { duration: '3m', target: 100, name: 'Stage 1: 100 Users Ramp-up' },
            // Ramp-up to 100 virtual users over 3 minutes
            { duration: '20m', target: 100, name: 'Stage 2: 100 Users stay' }
            // Stay at 100 virtual users for 20 minutes
        ] //,
        //     thresholds: {
     ...
     caseNumber
        ...
        variables: {
            data: {
                ...
                shortDesc: `TCM-6335 API Load Testing vu${Math.floor(Math.random() * 10000)}`,
