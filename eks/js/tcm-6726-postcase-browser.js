...
export default async function () {
    ...
    await page.goto('https://www1.aws.legalmatch.com/');
    // Select Category
    check(page, {
    ...
    await page
        ...
        .type('4354355345');
    await page.locator("input[name='email']").type('cypressapitest@guerrillamail.com');
    ...
    http.get('https://www1.aws.legalmatch.com/');
    http.get('https://www1.aws.legalmatch.com/post-case/env');
    http.post('https://www1.aws.legalmatch.com/home/client/file/upload.do?action');
}
