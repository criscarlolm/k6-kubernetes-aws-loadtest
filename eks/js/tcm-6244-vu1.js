...
export function Gradualload() {
    return {
        stages: [
            { duration: '5m', target: 1, name: 'Stage 1: 1 Users Ramp-up' }, // Ramp-up to 1 virtual user immediately
            { duration: '10m', target: 1, name: 'Stage 2: 1 Users Stay' }
     ...
     caseNumber
        ...
        variables: {
            data: {
                ...
                shortDesc: `TCM-6244 API Load Testing vu${Math.floor(Math.random() * 10000)}`,
